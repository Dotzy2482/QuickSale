namespace _20240305307_QuickSale
{
    partial class frmCustomers
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvCustomers.ColumnHeadersDefaultCellStyle.BackColor          = Color.FromArgb(241, 245, 249);
            dgvCustomers.ColumnHeadersDefaultCellStyle.ForeColor          = Color.FromArgb(100, 116, 139);
            dgvCustomers.ColumnHeadersDefaultCellStyle.Font               = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
            dgvCustomers.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(241, 245, 249);
            dgvCustomers.ColumnHeadersDefaultCellStyle.Padding            = new Padding(6, 0, 0, 0);
            dgvCustomers.DefaultCellStyle.Font                            = new Font("Segoe UI", 9.5F, FontStyle.Regular, GraphicsUnit.Point);
            dgvCustomers.DefaultCellStyle.Padding                         = new Padding(6, 0, 6, 0);
            dgvCustomers.AlternatingRowsDefaultCellStyle.BackColor        = Color.FromArgb(248, 250, 252);
            dgvCustomers.CellDoubleClick += new DataGridViewCellEventHandler(dgvCustomers_CellDoubleClick);
